          ...
          child: Column(
            children: [
              ...
              ElevatedButton(
                ...
                ElevatedButton(
                  onPressed: () {
                    if (_pickedImage == null || titleController.text == "" || contentController.text == ""
                     || dateController.text == "") {
                      showDialog(
                        context: context, 
                      ...
                      context.read<AddnewsBloc>().add(AddnewsInitial(title: title, content: content, date: date, image: image!,
                      ));
                    }
                  }, child: Text('Add News'),
                  ),
